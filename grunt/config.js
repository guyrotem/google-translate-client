...
module.exports = function (grunt) {
  ...
  function createApiProxy(src, dest) {
    var url = require('url');
  ...
  var proxySettings = require(__dirname + './../proxy-settings');
        ...
        options: {
          ...
          middleware: function (connect) {
            return [
              ...
              createApiProxy(proxySettings.translationServer.proxyPath, proxySettings.translationServer.serverUrl)
            ];
          }
        }
      },
    ...
    typescript: {
      ...
      mock: {
        ...
        options: {
          module: 'amd', //or commonjs
          target: 'es5', //or es3
          'base_path': 'test/mock', //quoting base_path to get around jshint warning.
          sourcemap: true,
          declaration: true
        }
      },
